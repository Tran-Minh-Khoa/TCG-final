...
router.post('/', async (req, res, next) => {
  try {
    ...
    if (user) {
      ...
      await EmailService({ customerMail: email, href: `https://tcg-trading-card-game-final.onrender.com/register/verify/${token}`, subject: "TCG-Trading Card Games - Email Verification" });
